...
mdl0 <- glm(cbind(V1, notV1) ~ date2 + cl_age90, data = dat.France.ages, family = "binomial")
summary(mdl0)

# Test date effect
mdl1 <- glm(cbind(V1, notV1) ~ cl_age90, data = dat.France.ages, family = "binomial")
summary(mdl1)
...
## Test age effect
mdl2 <- glm(cbind(V1, notV1) ~ date2 + factor(cl_age90), data = dat.France.ages, family = "binomial")
summary(mdl2)
